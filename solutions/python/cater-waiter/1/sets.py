...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    """
    remove_dup_dish_ingredients = set(dish_ingredients)
    return (dish_name, remove_dup_dish_ingredients)
...
def tag_special_ingredients(dish):
    ...
    special_ingredients = ingredient_set & SPECIAL_INGREDIENTS
...
def singleton_ingredients(dishes, intersection):
    ...
    candidates = all_ingredients - intersection
